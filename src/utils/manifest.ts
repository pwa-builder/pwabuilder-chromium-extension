...
import { findBestAppIcon, findSuitableIcon } from "./icons";
    ...
    return [
      ...
      },
      {
        ...
        result:
          !!mainIconInfo &&
          mainIconInfo.isPng &&
          mainIconInfo.isAtLeast(512, 512),
        category: "required",
      },
      {
        infoString:
          "512x512 or larger icon can be loaded succesfully from the network",
      ...
      },
      {
        ...
        result:
          !!context.manifest.icons &&
          context.manifest.icons.every((i) => !!i.type),
        category: "recommended",
      },
      {
        infoString: "Icons specify their size",
        result:
          !!context.manifest.icons &&
          context.manifest.icons.every((i) => !!i.sizes),
        category: "recommended",
      },
      {
        infoString: "Contains an IARC ID",
